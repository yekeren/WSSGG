...
from models import ws_sggen_ling
...
class WSSceneGraphRnnRefineV2(model_base.ModelBase):
  ...
  def __init__(self, options, is_training):
    ...
    elif proposal_network_oneof == 'ws_sggen_ling':
      self._proposal_network = ws_sggen_ling.WSSGGenLing(
          options.ws_sggen_ling, is_training)
